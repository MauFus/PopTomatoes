    ...
    implements popt.rmi.SeatsAllocator, java.rmi.Remote
{
    ...
    public boolean sellSeat(popt.data.Showtime $param_Showtime_1, popt.data.Seat[] $param_arrayOf_Seat_2)
	throws java.rmi.RemoteException
    {
	try {
	    Object $result = ref.invoke(this, $method_sellSeat_4, new java.lang.Object[] {$param_Showtime_1, $param_arrayOf_Seat_2}, 1242983295598941917L);
    ...
    public boolean sellSpecialSeat(popt.data.Showtime $param_Showtime_1, int $param_int_2)
	throws java.rmi.RemoteException
    {
	try {
	    Object $result = ref.invoke(this, $method_sellSpecialSeat_5, new java.lang.Object[] {$param_Showtime_1, new java.lang.Integer($param_int_2)}, -916941467028932297L);
	    return ((java.lang.Boolean) $result).booleanValue();
	} catch (java.lang.RuntimeException e) {
	    throw e;
	} catch (java.rmi.RemoteException e) {
